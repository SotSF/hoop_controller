...
- A song is composed of notes & chords. Given that we have to address an effectively arbitrary combination of 24 notes, a single 32-bit value is about as small as we can go for a single score-element. That's 4 bytes per song-element
