 ...
 * LEDstrip plugin
 *
 * This slowly rotates through the various colors
 * with waves of color pulsing at the hour boundaries
 *
 * for each chunk
 *   find middle of chunk, have this be the whitest, the edge be the darkest
 *   slowly exchange color
 *
